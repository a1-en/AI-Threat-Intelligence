      ...
      <div className="mb-8 text-center">
        {!session ? (
          ...
          <button
            ...
            className="inline-flex items-center px-6 py-2 bg-gray-700 hover:bg-gray-800 text-white font-semibold rounded-lg transition-all duration-200 focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
          >
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
