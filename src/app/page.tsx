    ...
    <div className="w-full max-w-2xl flex flex-col items-center">
      ...
      <div className="w-full flex flex-col gap-2 mb-6">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-400 text-base md:text-lg text-center mb-6">
            Analyze IPs, domains, emails, and hashes with AI-powered security
          </p>
          {session && (
            <button
              onClick={() => window.location.href = '/dashboard'}
              className="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-lg transition-all duration-200 focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 text-sm md:text-base"
            >
